// BUBBLEGUM/linear_gradient_brush
//
// Declarations for radial brushes.
//
...
#ifndef BUBBLEGUM_LINEAR_GRADIENT_BRUSH_H
#define BUBBLEGUM_LINEAR_GRADIENT_BRUSH_H
...
BUBBLEGUM_LINEAR_GRADIENT_BRUSH * bg_create_linear_gradient_brush(
...
/// method returns NULL.
BUBBLEGUM_LINEAR_GRADIENT_BRUSH * bg_to_linear_gradient_brush(
	BUBBLEGUM_BRUSH *brush);

/// Converts the BUBBLEGUM_LINEAR_GRADIENT_BRUSH to a BUBBLEGUM_BRUSH.
BUBBLEGUM_BRUSH * bg_from_radial_gradient_brush(BUBBLEGUM_LINEAR_GRADIENT_BRUSH *brush);
...
/// well.
void bg_add_linear_gradient_stop(BUBBLEGUM_LINEAR_GRADIENT_BRUSH *brush, BUBBLEGUM_COLOR *color, float offset);
...
/// step follows.
void bg_insert_linear_gradient_stop(BUBBLEGUM_LINEAR_GRADIENT_BRUSH *brush, int index, BUBBLEGUM_COLOR *color, float offset);

/// Removes the stop at the provided index. Does nothing if index is out-of-bounds.
void bg_remove_linear_gradient_brush(BUBBLEGUM_LINEAR_GRADIENT_BRUSH *brush, int index);

/// Gets the number of linear gradient stops.
int bg_get_num_linear_gradient_stops(BUBBLEGUM_LINEAR_GRADIENT_BRUSH *brush);

/// Gets the offset of the stop at the provided index.
///
/// If index is out-of-bounds, returns NaN.
float bg_get_linear_gradient_stop_offset(BUBBLEGUM_LINEAR_GRADIENT_BRUSH *brush, int index);

/// Gets the stop color.
///
/// If index is out-of-bounds, returns bg_get_invalid_color().
BUBBLEGUM_COLOR bg_get_linear_gradient_stop_color(BUBBLEGUM_LINEAR_GRADIENT_BRUSH *brush, int index);
