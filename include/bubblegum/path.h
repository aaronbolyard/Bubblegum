...
BUBBLEGUM_PATH * bg_create_path(BUBBLEGUM_CONTEXT *context);

/// Destroys the path.
void bg_destroy_path(BUBBLEGUM_PATH *path);
...
void bg_append_path_move(BUBBLEGUM_PATH *path, float x, float y, int flags);
void bg_append_path_line(BUBBLEGUM_PATH *path, float x, float y, int flags);
void bg_append_path_quadratic_curve(
	BUBBLEGUM_PATH *path,
	float anchor_x, float anchor_y,
	float x, float y,
	int flags);
void bg_append_path_cubic_curve(
	BUBBLEGUM_PATH *path,
	float anchor1_x, anchor1_y,
	float anchor2_x, anchor2_y,
	float x, float y,
	int flags);
void bg_append_path_close(
	BUBBLEGUM_PATH *path,
	int flags);
void bg_insert_path_move(BUBBLEGUM_PATH *path, int index, float x, float y, int flags);
void bg_insert_path_line(BUBBLEGUM_PATH *path, int index, float x, float y, int flags);
void bg_insert_path_quadratic_curve(
	BUBBLEGUM_PATH *path,
	int index,
	float anchor_x, float anchor_y,
	float x, float y,
	int flags);
void bg_insert_path_cubic_curve(
	BUBBLEGUM_PATH *path,
	int index,
	float anchor1_x, anchor1_y,
	float anchor2_x, anchor2_y,
...
int bg_get_path_command_type(BUBBLEGUM_PATH *path, int command_index);
float bg_get_path_command_x(BUBBLEGUM_PATH *path, int command_index, int x_index);
float bg_get_path_command_y(BUBBLEGUM_PATH *path, int command_index, int y_index);
int bg_get_path_command_flags(BUBBLEGUM_PATH *path, int command_index);
